...
from models_zf_to_pwm import *
import argparse
# -d_add C:/Users/User/PycharmProjects/zf_binding_pref/Transfer_learning/data_labels/ -add C:/Users/User/PycharmProjects/zf_binding_pref/Transfer_learning/pipeline/results -zf_p_df zf_pred_max_df.csv -lr 0.001 -e 2 -res_num 4 -r 0 -t_v retrain
